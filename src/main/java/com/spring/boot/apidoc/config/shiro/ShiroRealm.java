...
import com.spring.boot.apidoc.entity.SysPermission;
import com.spring.boot.apidoc.entity.SysRole;
...
public class ShiroRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        logger.info("DemoShiroRealm.doGetAuthenticationInfo() 中文乱码测试");
...
//        );
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        * 缓存过期之后会再次执行。
        */
        logger.info("权限配置-->DemoShiroRealm.doGetAuthorizationInfo()");
